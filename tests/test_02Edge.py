...
def test_main():
    ...
    # test 1
    col_1 = Edge.IsCollinear(e1,e5)                                         # without optional inputs
    ...
    # test 3
    col_3 = Edge.IsCollinear(e1,e5, mantissa=3, tolerance=0.001)     # with optional inputs
    assert isinstance(col_3, bool), "Edge.IsCollinear. Should be bool"

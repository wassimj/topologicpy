...
def test_main():
    ...
    fV1 = Face.ByVertices([v9, v10, v12, v11])                     # create face
    fV2 = Face.ByVertices([v11, v12, v13])                  # create face
    fV3 = Face.ByVertices([v13, v9, v10])                   # create face
    # creating shell
    ...
    sh4 = Shell.ByFaces([fV1, fV2])                                     # create shell
